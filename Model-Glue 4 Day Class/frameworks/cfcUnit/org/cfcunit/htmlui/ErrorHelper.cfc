...
<cfcomponent name="ErrorHelper" extends="org.cfcunit.Object" output="false" hint="">
	...
	<cfproperty name="fDatabaseHelper" type="org.cfcunit.htmlui.DatabaseErrorHelper" hint=""/>
	
	<cfset variables.fDatabaseHelper = NULL>
	
	<!---------------------------------------------------------------------------------->

	<cffunction name="init" returntype="ErrorHelper" access="public" output="false" hint="">
		<cfset variables.fDatabaseHelper = newObject("org.cfcunit.htmlui.DatabaseErrorHelper")>
	...
	<cffunction name="getErrorInfo" returntype="struct" access="public" output="false" hint="">
		...
		<cfset data["name"] = arguments.exception.getClass().getName()>
		...
		<cfswitch expression="#data.type#">
			<cfcase value="database">
				<cfset variables.fDatabaseHelper.parseException(arguments.exception, data)>
			</cfcase>
