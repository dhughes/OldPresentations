...
<cfcomponent name="Parameters" extends="org.cfcunit.service.TestParameters" output="false">
	...
	<cffunction name="init" returntype="Parameters" access="public" output="false">
