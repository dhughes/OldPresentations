...
<cfcomponent name="ExceptionStub" output="false">

	<!------------------------------------------------------------------------------------>


	<cffunction name="init" returntype="ExceptionStub" access="public" output="false">
	...
	<cffunction name="addTraceElement" returntype="void" access="public" output="false">
		...
		<cfset var element = createObject("component", "StackTraceElement").init(argumentCollection=arguments)>
