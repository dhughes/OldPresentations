<cfcomponent displayname="Controller" extends="ModelGlue.unity.controller.Controller" output="false">
    ...
    <cffunction name="setFortuneService" access="public" output="false" returntype="void">
       <cfargument name="fortuneService" hint="I am the service to use to get fortune data." required="yes" type="Fortune - Reactor.model.FortuneService" />
       <cfset variables.fortuneService = arguments.fortuneService />
    </cffunction>
    <cffunction name="getFortuneService" access="public" output="false" returntype="Fortune - Reactor.model.FortuneService">
